            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6 border-b border-gray-200 pb-4">
                        <h2 class="text-2xl font-semibold text-gray-800">Add New Doctor</h2>
                        <p class="mt-1 text-sm text-gray-500">Enter the doctor's personal details, specialization,
                            qualifications and
                            other information.</p>
                    </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="first_name" required input type="text" name="first_name"
                                ...
                                <div>
                                    <label for="assigned_clinic"
                                        class="block text-sm font-medium text-gray-700 mb-1">Assigned Clinic<span
                                            class="text-red-500">*</span></label>
                                    <input type="text" name="assigned_clinic" id="assigned_clinic" required
                                        class="w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition duration-150"
